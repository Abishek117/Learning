...
public class ClassTreeMap
{
	public TreeMap<Integer, String> treeMap()
	{
		...
		//System.out.println(tm.ceilingEntry(20));			//It returns the key-value pair having the first key, greater than or equal to the specified key, or null if there is no such key
		...
		//System.out.println(tm.floorKey(23));	 			//It returns the key which is less or equal to the specified key or null if there is no such key
		...
		//System.out.println(tm.pollFirstEntry());			//retrieves and removes first key-value in a set
		//System.out.println(tm.pollLastEntry());			//retrieves and removes last key-value in a set
