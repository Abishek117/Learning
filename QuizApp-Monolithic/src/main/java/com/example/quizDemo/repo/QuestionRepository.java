...
public interface QuestionRepository extends JpaRepository<Questions, Integer> {
	...
	@Query(nativeQuery = true, value = "select * from questions where category=:category ORDER BY RAND() LIMIT :count")
	public List<Questions> findRandomQuestionsByCategory(String category, int count);
